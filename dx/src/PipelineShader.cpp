...
PipelineShader::PipelineShader(std::string shader,
    ...
    HRESULT result    = D3DCompileFromFile(shaderString.c_str(),
                                           0,
    ...
    result            = D3DCompileFromFile(shaderString.c_str(),
                                           0,
                                           D3D_COMPILE_STANDARD_FILE_INCLUDE,
                                           "PS",
                                           "ps_5_0",
...
std::wstring PipelineShader::stringToLPCWSTR(const std::string& s) {
    ...
    int      modLen  = MultiByteToWideChar(CP_ACP,
                                           0,
                                           s.c_str(),
                                           slength,
                                           buf,
