...
Matrix Camera::getProjection() {
    return _mvp.getProjectionMatrix();
}

Matrix Camera::getView() {
    return _mvp.getViewMatrix();
}

Camera::ViewState Camera::getViewState() {
    return _viewState;
}

void Camera::updateState(int milliseconds) {
