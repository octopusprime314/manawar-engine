...
AnimatedModel::AnimatedModel(std::string name) :
    ...
    _fbxLoader->loadAnimatedModel(this,
                                  _fbxLoader->getScene()->GetRootNode());
    ...
    geometryLoader.loadGeometry(this,
                                geometryLoader.getScene()->GetRootNode());
    ...
    _vao[0]->createVAO(&_renderBuffers,
                       ModelClass::AnimatedModelType,
