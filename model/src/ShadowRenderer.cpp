    ...
    for (Light* light : lights) {
        ...
        for (Model* model : modelList) {
            ...
            if (model->getClassType() == ModelClass::ModelType) {
                ...
                glUniformMatrix4fv(_staticShadowShader.getModelLocation(), 1, GL_TRUE, modelMVP->getModelBuffer());

                //glUniform mat4 view matrix, GL_TRUE is telling GL we are passing in the matrix as row major
                glUniformMatrix4fv(_staticShadowShader.getViewLocation(), 1, GL_TRUE, lightMVP.getViewBuffer());

                //glUniform mat4 projection matrix, GL_TRUE is telling GL we are passing in the matrix as row major
                glUniformMatrix4fv(_staticShadowShader.getProjectionLocation(), 1, GL_TRUE, lightMVP.getProjectionBuffer());
                ...
                //glUniform mat4 combined model and world matrix, GL_TRUE is telling GL we are passing in the matrix as row major
                glUniformMatrix4fv(_animatedShadowShader.getModelLocation(), 1, GL_TRUE, modelMVP->getModelBuffer());

                //glUniform mat4 view matrix, GL_TRUE is telling GL we are passing in the matrix as row major
                glUniformMatrix4fv(_animatedShadowShader.getViewLocation(), 1, GL_TRUE, lightMVP.getViewBuffer());

                //glUniform mat4 projection matrix, GL_TRUE is telling GL we are passing in the matrix as row major
                glUniformMatrix4fv(_animatedShadowShader.getProjectionLocation(), 1, GL_TRUE, lightMVP.getProjectionBuffer());
