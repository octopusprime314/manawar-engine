    ...
    if (diffuse.a < 0.1) {
        ...
        for (int i = 0; i < numPointLights; i++) {
            ...
            if (distanceFromLight < pointLightRanges[i]) {
                ...
                pointLighting += (dot(pointLightDirNorm, vsData.normalOut)) *
                ...
                vec3 cubeMapTexCoords = (viewToModelMatrix * vec4(vsData.positionOut.xyz, 1.0)).xyz -
        ...
        vec3 lightComponentIllumination = (illumination * diffuse.rgb) + (pointLighting * diffuse.rgb);
